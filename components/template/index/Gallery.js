    ...
    return (
        <div className='w-full flex items-end justify-end relative'>
            <Image
                ...
                className="w-[570px] h-[650px] object-center rounded-4xl"
            />
            <div className='absolute z-10 left-10 top-6 flex items-center flex-col'>
                <div className='w-[200px] h-[170px] flex items-start flex-col justify-center bg-[#FFFFFF9C]/70 border border-[#FFFFFF] rounded-4xl px-5 py-5'>
                    <span className='flex items-center gap-1 text-white'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                            <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" />
                        </svg>
                        <p className='font-vazirBold'>{cityArry[number].cityName}</p>
                    </span>
                    <p className='text-6xl text-white font-iranYekanBold'>{cityArry[number].capitalCity}</p>
                </div>
