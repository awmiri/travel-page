    ...
    return (
        <div className='w-[250px]  bg-gray-100/20 border border-[#EDEFF2] shadow p-3'>
            <ul className='flex flex-col gap-4'>
                ...
                <div className={`flex flex-col gap-3 p-2 rounded-lg transition-all duration-300 group ${pathName.startsWith("/p-admin/blog") ? "bg-white shadow" : "hover:bg-white hover:shadow"}`}>
                    <div className='flex items-center justify-between w-full'>
                        ...
                        <div className='flex items-center gap-3'>
                            <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`size-5 text-[#6B7A99] text-shadow-lg transition group-hover:rotate-180 duration-300 ${pathName === "/p-admin/blog" ? "rotate-180" : " rotate-0"}`}>
                    ...
                    <ul className={`grid grid-rows-[0fr] group-hover:grid-rows-[1fr] transition-all duration-300 ease-in-out overflow-hidden ${pathName.startsWith("/p-admin/blog") ? "grid-rows-[1fr]" : ""}`}>
                        <div className="min-h-0 flex flex-col gap-4 px-2.5">
                            {/* لینک‌ها اینجا */}
                            <Link href={"/p-admin/blog/create"} className='flex items-center gap-1 '>
                                ...
                                <p className='font-vazirBold text-[#6B7A99] hover:text-green-600 text-[13px]  '>ساخت‌بلاگ</p>
                            </Link>
                            <Link href={"/p-admin/blog"} className='flex items-center justify-between'>
                                <div className='flex items-center gap-1'>
                                    ...
                                    <p className='font-vazirBold text-[#6B7A99] hover:text-green-600 text-[13px]'>بلاگ‌</p>
                                </div>
                                <div className=' p-1.5 font-vazirBold rounded-full bg-gray-100 shadow text-sm text-[#6B7A99] w-[20px] h-[20px] flex items-center justify-center'>{countBlog}</div>
                            </Link>
                        </div>
                    </ul>
                </div>
