    ...
    return (
        <div className='bg-black/30 w-[300PX] h-[460px] rounded-2xl'>
            ...
            <div className='px-3 flex flex-col justify-between h-[260px] '>
                ...
                <div className=' line-clamp-3 mt-2.5 text-sm font-iranYekanMedium text-textLight/60 dark:text-blue-50/50'>{blogs.description}</div>
                <div className='flex items-baseline-last justify-between mt-2.5 text-textLight dark:text-blue-50/50'>
                ...
                <div className='text-center gap-1 p-3 border-t mt-2 text-textLight/80 dark:text-blue-50 font-vazirBold transition'>
