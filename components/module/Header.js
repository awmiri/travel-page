                ...
                <div className='mx-[20px] md:mx-[24px] query1000:mx-[60px] query1120:mx-[71.5px] py-[15px] flex items-center justify-between'>
                    ...
                    <div className='flex items-center gap-2 query860:gap-2.5 query1120:gap-5'>
                        ...
                        {/* login btn */}
                        {
                            userLogin ? (
                                <>
                                    <div className='w-[50px] h-[50px] relative z-30 border flex items-center justify-center rounded-full' onClick={() => setOpenUserInfo((prev) => !prev)}>
                                        {
                                            userContent.profile ? (
                                            ...
                                            <div>
                                                ...
                                                <div className='border-t border-b'>
                                                    <ul className='mt-4 mb-4'>
                                                        ...
                                                        {
                                                            userAdmin ? (
                                                                <Link href={"p-admin/dashboard"} className='flex items-center gap-2 font-iranYekanMedium px-2 py-2.5 hover:bg-white/10 delay-75 transition rounded-[10px]'>
                                                                    <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
