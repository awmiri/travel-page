        ...
        <>
            <div className='border-b border-textLight/40 dark:text-white/25 transition'>
                <div className='mx-[20px] md:mx-[24px] query1000:mx-[60px] query1120:mx-[71.5px] py-[15px] flex items-center justify-between'>
                    ...
                    <div className='cursor-pointer' onClick={() => setOpenMobileNav(true)}>
            ...
            <div className={`bg-black/15 absolute z-10 w-full h-dvh top-0 sm:hidden transition-all duration-200 ${openMobileNav ? 'opacity-100 visible' : 'opacity-0 invisible'}`}></div>
        </>
    )
}
